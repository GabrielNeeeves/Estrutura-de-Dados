...
public class Lab_02_ProjetosJava_APOS_AULA_V2 {
	...
	public static void main(String[] args) throws Exception {
		...
		// instanciação de um objeto da classe 'Lab_02_Projetos...'
		// para acesso ao restante da classe, isto é, aos seu(s) método(s)
		// formato:
		// <nomeClasse> <idObjeto> = new <nomeClasse>(lista de argumentos, se houver);
		Lab_02_ProjetosJava_APOS_AULA_V2 metodos = new Lab_02_ProjetosJava_APOS_AULA_V2();
